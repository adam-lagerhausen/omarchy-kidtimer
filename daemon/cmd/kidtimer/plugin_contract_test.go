...
func TestPluginQMLIsHTTPClientNotBank(t *testing.T) {
	...
	mustContain(t, kidOverlay, "save now", "save cover title")
	mustContain(t, kidOverlay, "Super still works", "save cover super")
	mustContain(t, kidOverlay, "Dismiss", "save cover dismiss")
	mustContain(t, kidOverlay, "overlayBlocksSuper", "overlay delays super")
	mustContain(t, kidOverlay, "saveDismissed", "dismissed save cover")
	mustContain(t, kidModel, "function overlaySaveCover", "save cover helper")
	mustContain(t, kidModel, "function overlayBlocksSuper", "super after slam")
	mustContain(t, kidModel, "function overlayWindowOn", "dismiss hides cover")
	mustContain(t, kidModel, "function saveSeconds", "save countdown")
