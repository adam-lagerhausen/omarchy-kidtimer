...
func TestPluginQMLIsHTTPClientNotBank(t *testing.T) {
	...
	mustContain(t, kidOverlay, `root.face !== "break"`, "break hides ask and pin")
	...
	mustContain(t, parentBar, "grantAllowed", "right-click grant respects bedtime and lock")
	mustContain(t, parentModel, "function grantAllowed", "grant while bedtime or locked")
