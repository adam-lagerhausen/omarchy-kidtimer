...
assertEqual(kid.playMinutesOf({}), 45, "play default")
assertEqual(kid.playMinutesOf({ play_minutes: 0 }), 45, "play unset")
assertEqual(kid.playMinutesOf({ play_minutes: 60 }), 60, "play stored")
assertEqual(kid.breakMinutesOf({}), 15, "break default")
assertEqual(kid.breakMinutesOf({ break_minutes: 0 }), 15, "break unset")
assertEqual(kid.clampPlayMin(14), 15, "play floor")
assertEqual(kid.clampPlayMin(241), 240, "play ceil")
assertEqual(kid.clampBreakMin(14), 15, "break floor")
assertEqual(kid.clampBreakMin(121), 120, "break ceil")
assertEqual(kid.minutesLabel(45), "45m", "play label")
assertEqual(kid.minutesLabel(60), "1h", "hour label")
assertEqual(kid.parseStatus({}).play_minutes, 45, "parse play default")
assertEqual(kid.parseStatus({ play_minutes: 90, break_minutes: 30 }).break_minutes, 30, "parse break")
assertEqual(kid.nudgeSession({ play_minutes: 45, break_minutes: 15 }, null, "play", 15).playMin, 60, "nudge play")
assertEqual(kid.nudgeSession({ play_minutes: 45, break_minutes: 15 }, null, "play", 15).breakMin, 15, "nudge keeps break")
assertEqual(kid.sessionWire(kid.nudgeSession({ play_minutes: 45, break_minutes: 15 }, null, "play", 15)).play_minutes, 60, "wire play")
assertEqual(kid.nudgeSession({ play_minutes: 45, break_minutes: 15 }, { playMin: 60, breakMin: 15 }, "break", 15).breakMin, 30, "nudge from hold")
assertEqual(kid.nudgeSession({ play_minutes: 15 }, null, "play", -15).playMin, 15, "play nudge floor")
assertEqual(kid.nudgeSession({ break_minutes: 120 }, null, "break", 15).breakMin, 120, "break nudge ceil")
...
assertEqual(kid.pinEndBreakPayload("1234"), { pin: "1234" }, "end-break payload")
...
assertEqual(kid.overlayFace({ overlay: true, groups: { fun: 1800 }, break_seconds: 900 }), "break", "overlay break")
assertEqual(kid.overlayFace({ overlay: true, parent_locked: true, break_seconds: 900 }), "locked", "lock beats break")
assertEqual(kid.overlayFace({ overlay: true, bedtime_active: true, break_seconds: 900 }), "bedtime", "bedtime beats break")
assertEqual(kid.breakSeconds({ break_seconds: 900 }), 900, "break seconds")
assertEqual(kid.breakCountdown({ break_seconds: 900 }), "15:00", "break countdown start")
assertEqual(kid.breakCountdown({ break_seconds: 59 }), "0:59", "break countdown seconds")
assertEqual(kid.barLabel({ overlay: true, groups: { fun: 1800 }, break_seconds: 900 }), "break", "break chip")
