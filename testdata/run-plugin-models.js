...
const ping = parent.pingCard({ id: "a1", seconds: 600 }, { name: "Ada", status: {} }, 0)
...
assertEqual(parent.pingDecide(ping, "approve"), { id: "a1", kidIndex: 0, decision: "approve" }, "ping approve")
assertEqual(parent.pingDecide(ping, "deny"), { id: "a1", kidIndex: 0, decision: "deny" }, "ping deny")
...
pingQ = parent.enqueuePing(pingQ, parent.pingCard({ id: "a2", seconds: 1800 }, { name: "Ada" }, 0))
assertEqual(pingQ.length, 2, "second ping")
pingQ = parent.dismissPing(pingQ, ping)
assertEqual(pingQ.map(p => p.id), ["a2"], "dismiss ping")
assertEqual(parent.pingCard({ id: "a3", seconds: 600 }, { name: "Ada", status: { parentLocked: true } }, 1).body,
  "Ada asked to unlock for 10 more minutes", "locked ping matches panel")
pingQ = parent.prunePings(pingQ, [{ name: "Ada", claimed: false, status: {}, asks: [{ id: "a2", seconds: 1800 }] }])
...
assertEqual(parent.pingCard({ id: "a1", seconds: 600 }, { name: "<Ada>" }, 0).head, "Ada", "ping strips host markup")
