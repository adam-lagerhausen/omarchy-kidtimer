...
assertEqual(errKid.pickerLine.indexOf("Error") >= 0, true, "picker status")
...
assertEqual(home.track.log[0].clock, "07:40", "log clock")
assertEqual(home.track.log[0].name, "CHROME", "log chrome")
assertEqual(home.track.log[2].name, "MINECRAFT", "log minecraft")
...
assertEqual(kid.bedtimeEnd({ bedtime_end: "07:00" }), "07:00", "bedtime end")
