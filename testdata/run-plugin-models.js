...
assertEqual(kid.barLabel({ bedtime_active: false, groups: { fun: 59 } }), "1min left", "last minute chip")
...
assertEqual(kid.clockFace({ groups: { fun: 59 } }).leftLabel, "1min LEFT", "last minute clock")
